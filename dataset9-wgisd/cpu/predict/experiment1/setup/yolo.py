...
parser.add_argument('--device', type=str, default="cpu", help='Device to use (0 = GPU, -1 = CPU)')
...
if args.eval:
    # Evaluation mode
    results = model.val(data='data_yolo.yaml', split='test', batch=args.batch_size, half=False, device=args.device)
